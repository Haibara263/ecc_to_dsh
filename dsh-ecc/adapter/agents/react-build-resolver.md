...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/react-build-resolver.md`

## 调用说明

- **用途**：Diagnose and fix React build failures across Vite, webpack, Next.js, CRA, Parcel, esbuild, and Bun. Handles JSX/TSX compile errors, hydration mismatches, server/client component boundary failures, missing types, and bundler-specific configuration issues with minimal, surgical changes. MUST BE USED when a React build fails.
