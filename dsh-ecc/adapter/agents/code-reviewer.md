...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/code-reviewer.md`

## 调用说明

- **用途**：Expert code review specialist. Proactively reviews code for quality, security, and maintainability. Use immediately after writing or modifying code. MUST BE USED for all code changes.
