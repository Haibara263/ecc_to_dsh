...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/gan-planner.md`

## 调用说明

- **用途**："GAN Harness — Planner agent. Expands a one-line prompt into a full product specification with features, sprints, evaluation criteria, and design direction."
- **工具映射**：read, write, grep, glob
