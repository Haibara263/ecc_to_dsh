...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/fastapi-reviewer.md`

## 调用说明

- **用途**：Reviews FastAPI applications for async correctness, dependency injection, Pydantic schemas, security, OpenAPI quality, testing, and production readiness.
