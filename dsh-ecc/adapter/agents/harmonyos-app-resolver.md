...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/harmonyos-app-resolver.md`

## 调用说明

- **用途**：HarmonyOS application development expert specializing in ArkTS and ArkUI. Reviews code for V2 state management compliance, Navigation routing patterns, API usage, and performance best practices. Use for HarmonyOS/OpenHarmony projects.
