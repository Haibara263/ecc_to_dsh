...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/network-architect.md`

## 调用说明

- **用途**：Designs enterprise or multi-site network architecture from requirements, using existing network skills for focused routing, validation, automation, and troubleshooting detail.
- **工具映射**：read, grep
