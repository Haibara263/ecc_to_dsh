...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/homelab-architect.md`

## 调用说明

- **用途**：Designs home and small-lab network plans from hardware inventory, goals, and operator experience level, with safe staged changes and rollback guidance.
- **工具映射**：read, grep
