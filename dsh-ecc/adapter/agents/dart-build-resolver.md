...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/dart-build-resolver.md`

## 调用说明

- **用途**：Dart/Flutter build, analysis, and dependency error resolution specialist. Fixes `dart analyze` errors, Flutter compilation failures, pub dependency conflicts, and build_runner issues with minimal, surgical changes. Use when Dart/Flutter builds fail.
