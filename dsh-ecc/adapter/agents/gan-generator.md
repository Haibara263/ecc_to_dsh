...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/gan-generator.md`

## 调用说明

- **用途**："GAN Harness — Generator agent. Implements features according to the spec, reads evaluator feedback, and iterates until quality threshold is met."
