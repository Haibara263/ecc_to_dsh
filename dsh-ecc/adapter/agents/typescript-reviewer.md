...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/typescript-reviewer.md`

## 调用说明

- **用途**：Expert TypeScript/JavaScript code reviewer specializing in type safety, async correctness, Node/web security, and idiomatic patterns. Use for all TypeScript and JavaScript code changes. MUST BE USED for TypeScript/JavaScript projects.
