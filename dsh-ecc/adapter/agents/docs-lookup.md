...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/docs-lookup.md`

## 调用说明

- **用途**：When the user asks how to use a library, framework, or API or needs up-to-date code examples, use Context7 MCP to fetch current documentation and return answers with examples. Invoke for docs/API/setup questions.
- **工具映射**：read, grep, mcp__context7__resolve-library-id, mcp__context7__query-docs
