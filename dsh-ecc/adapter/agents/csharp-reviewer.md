...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/csharp-reviewer.md`

## 调用说明

- **用途**：Expert C# code reviewer specializing in .NET conventions, async patterns, security, nullable reference types, and performance. Use for all C# code changes. MUST BE USED for C# projects.
