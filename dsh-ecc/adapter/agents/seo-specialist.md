...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/seo-specialist.md`

## 调用说明

- **用途**：SEO specialist for technical SEO audits, on-page optimization, structured data, Core Web Vitals, and content/keyword mapping. Use for site audits, meta tag reviews, schema markup, sitemap and robots issues, and SEO remediation plans.
- **工具映射**：read, grep, glob, web_search, browser_open / browser_content
