...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/swift-reviewer.md`

## 调用说明

- **用途**：Expert Swift code reviewer specializing in protocol-oriented design, value semantics, ARC memory management, Swift Concurrency, and idiomatic patterns. Use for all Swift code changes. MUST BE USED for Swift projects.
