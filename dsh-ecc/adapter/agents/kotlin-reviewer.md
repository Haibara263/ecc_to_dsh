...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/kotlin-reviewer.md`

## 调用说明

- **用途**：Kotlin and Android/KMP code reviewer. Reviews Kotlin code for idiomatic patterns, coroutine safety, Compose best practices, clean architecture violations, and common Android pitfalls.
