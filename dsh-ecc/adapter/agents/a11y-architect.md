...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/a11y-architect.md`

## 调用说明

- **用途**：Accessibility Architect specializing in WCAG 2.2 compliance for Web and Native platforms. Use PROACTIVELY when designing UI components, establishing design systems, or auditing code for inclusive user experiences.
- **工具映射**：read, write, edit, grep, glob
