...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/php-reviewer.md`

## 调用说明

- **用途**：Expert PHP code reviewer specializing in PSR-12 compliance, PHP type system, Eloquent ORM patterns, security, and performance. Use for all PHP code changes. MUST BE USED for PHP projects.
