...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/cpp-build-resolver.md`

## 调用说明

- **用途**：C++ build, CMake, and compilation error resolution specialist. Fixes build errors, linker issues, and template errors with minimal changes. Use when C++ builds fail.
