...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/pr-test-analyzer.md`

## 调用说明

- **用途**：Review pull request test coverage quality and completeness, with emphasis on behavioral coverage and real bug prevention.
