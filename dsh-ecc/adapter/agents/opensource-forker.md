...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/opensource-forker.md`

## 调用说明

- **用途**：Fork any project for open-sourcing. Copies files, strips secrets and credentials (20+ patterns), replaces internal references with placeholders, generates .env.example, and cleans git history. First stage of the opensource-pipeline skill.
