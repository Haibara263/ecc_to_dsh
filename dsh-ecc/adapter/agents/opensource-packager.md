...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/opensource-packager.md`

## 调用说明

- **用途**：Generate complete open-source packaging for a sanitized project. Produces CLAUDE.md, setup.sh, README.md, LICENSE, CONTRIBUTING.md, and GitHub issue templates. Makes any repo immediately usable with Claude Code. Third stage of the opensource-pipeline skill.
