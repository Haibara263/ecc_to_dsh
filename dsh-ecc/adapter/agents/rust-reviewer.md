...
> ECC 子代理适配为 DSH subagent 提示词。原文件：`agents/rust-reviewer.md`

## 调用说明

- **用途**：Expert Rust code reviewer specializing in ownership, lifetimes, error handling, unsafe usage, and idiomatic patterns. Use for all Rust code changes. MUST BE USED for Rust projects.
